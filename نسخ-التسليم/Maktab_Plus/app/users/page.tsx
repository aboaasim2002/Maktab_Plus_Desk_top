        ...
        setUsers((current) => current.map((user) =>
          user.id === editing.id
            ? {
                ...
                permission_mode: editing.role === 'office_owner' ? 'all' : form.permission_mode,
                is_active: editing.role === 'office_owner' ? true : form.is_active,
              ...
              {filteredUsers.map((user) => (
                <tr key={user.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 text-center text-gray-600">
                    {user.role === 'office_owner' || user.permission_mode === 'all'
                      ? 'كافة الصلاحيات'
        ...
        <form onSubmit={save} className="space-y-5">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <label>
              ...
              <select className="input-field" value={form.permission_mode} disabled={editing?.role === 'office_owner'} onChange={(e) => setForm({ ...form, permission_mode: e.target.value as 'all' | 'custom' })}>
          ...
          {form.permission_mode === 'custom' && editing?.role !== 'office_owner' && (

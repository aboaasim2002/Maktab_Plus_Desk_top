...
/** تنسيق المبلغ كرقم فقط دون رمز أو اسم العملة */
...
/** تنسيق التاريخ بأرقام وترتيب إنجليزي ثابت: DD/MM/YYYY */
...
export function formatDateShort(dateStr: string): string {
  ...
  return `${toEnglishDigits(day.padStart(2, '0'))}/${toEnglishDigits(month.padStart(2, '0'))}/${toEnglishDigits(year)}`;
}
